          ...
          output.split(/\r?\n/).forEach(function (line) {
            ...
            if (matches_line_col != null) {
              toReturn.push({
                ...
                range: matches_line_col[4] == undefined ? helpers.rangeFromLineNumber(activeEditor, Number.parseInt((matches_line_col[3] - 1))) : [[Number.parseInt(matches_line_col[3]) - 1, Number.parseInt(matches_line_col[4]) - 1], [Number.parseInt(matches_line_col[3]) - 1, Number.parseInt(matches_line_col[4])]],
                filePath: file,
              });
            }
